...
public static class RegionName: System.Object {
	...
	private static void init_region_names() {
		...
		cc_reg_AF.Add( "15", "Konar" );
		cc_reg_AF.Add( "16", "Laghman" );
		cc_reg_AF.Add( "17", "Lowgar" );
		cc_reg_AF.Add( "18", "Nangarhar" );
		cc_reg_AF.Add( "19", "Nimruz" );
		cc_reg_AF.Add( "21", "Paktia" );
		cc_reg_AF.Add( "22", "Parvan" );
		...
		cc_reg_BD.Add( "05", "Comilla" );
		cc_reg_BD.Add( "12", "Mymensingh" );
		cc_reg_BD.Add( "13", "Noakhali" );
		cc_reg_BD.Add( "15", "Patuakhali" );
		cc_reg_BD.Add( "22", "Bagerhat" );
		cc_reg_BD.Add( "23", "Bhola" );
		cc_reg_BD.Add( "24", "Bogra" );
		cc_reg_BD.Add( "25", "Barguna" );
		cc_reg_BD.Add( "26", "Brahmanbaria" );
		cc_reg_BD.Add( "27", "Chandpur" );
		cc_reg_BD.Add( "28", "Chapai Nawabganj" );
		cc_reg_BD.Add( "29", "Chattagram" );
		cc_reg_BD.Add( "30", "Chuadanga" );
		cc_reg_BD.Add( "31", "Cox's Bazar" );
		cc_reg_BD.Add( "32", "Dhaka" );
		cc_reg_BD.Add( "33", "Dinajpur" );
		cc_reg_BD.Add( "34", "Faridpur" );
		cc_reg_BD.Add( "35", "Feni" );
		cc_reg_BD.Add( "36", "Gaibandha" );
		cc_reg_BD.Add( "37", "Gazipur" );
		cc_reg_BD.Add( "38", "Gopalganj" );
		cc_reg_BD.Add( "39", "Habiganj" );
		cc_reg_BD.Add( "40", "Jaipurhat" );
		cc_reg_BD.Add( "41", "Jamalpur" );
		cc_reg_BD.Add( "42", "Jessore" );
		cc_reg_BD.Add( "43", "Jhalakati" );
		cc_reg_BD.Add( "44", "Jhenaidah" );
		cc_reg_BD.Add( "45", "Khagrachari" );
		cc_reg_BD.Add( "46", "Khulna" );
		cc_reg_BD.Add( "47", "Kishorganj" );
		cc_reg_BD.Add( "48", "Kurigram" );
		cc_reg_BD.Add( "49", "Kushtia" );
		cc_reg_BD.Add( "50", "Laksmipur" );
		cc_reg_BD.Add( "51", "Lalmonirhat" );
		cc_reg_BD.Add( "52", "Madaripur" );
		cc_reg_BD.Add( "53", "Magura" );
		cc_reg_BD.Add( "54", "Manikganj" );
		cc_reg_BD.Add( "55", "Meherpur" );
		cc_reg_BD.Add( "56", "Moulavibazar" );
		cc_reg_BD.Add( "57", "Munshiganj" );
		cc_reg_BD.Add( "58", "Naogaon" );
		cc_reg_BD.Add( "59", "Narail" );
		cc_reg_BD.Add( "60", "Narayanganj" );
		cc_reg_BD.Add( "61", "Narsingdi" );
		cc_reg_BD.Add( "62", "Nator" );
		cc_reg_BD.Add( "63", "Netrakona" );
		cc_reg_BD.Add( "64", "Nilphamari" );
		cc_reg_BD.Add( "65", "Pabna" );
		cc_reg_BD.Add( "66", "Panchagar" );
		cc_reg_BD.Add( "67", "Parbattya Chattagram" );
		cc_reg_BD.Add( "68", "Pirojpur" );
		cc_reg_BD.Add( "69", "Rajbari" );
		cc_reg_BD.Add( "70", "Rajshahi" );
		cc_reg_BD.Add( "71", "Rangpur" );
		cc_reg_BD.Add( "72", "Satkhira" );
		cc_reg_BD.Add( "73", "Shariyatpur" );
		cc_reg_BD.Add( "74", "Sherpur" );
		cc_reg_BD.Add( "75", "Sirajganj" );
		cc_reg_BD.Add( "76", "Sunamganj" );
		cc_reg_BD.Add( "77", "Sylhet" );
		cc_reg_BD.Add( "78", "Tangail" );
		cc_reg_BD.Add( "79", "Thakurgaon" );
		...
		cc_reg_CZ.Add( "20", "Hradec Kralove" );
		cc_reg_CZ.Add( "21", "Jablonec nad Nisou" );
		cc_reg_CZ.Add( "23", "Jicin" );
		cc_reg_CZ.Add( "24", "Jihlava" );
		cc_reg_CZ.Add( "30", "Kolin" );
		cc_reg_CZ.Add( "33", "Liberec" );
		cc_reg_CZ.Add( "36", "Melnik" );
		cc_reg_CZ.Add( "37", "Mlada Boleslav" );
		cc_reg_CZ.Add( "39", "Nachod" );
		cc_reg_CZ.Add( "41", "Nymburk" );
		cc_reg_CZ.Add( "45", "Pardubice" );
		cc_reg_CZ.Add( "52", "Hlavni mesto Praha" );
		cc_reg_CZ.Add( "61", "Semily" );
		cc_reg_CZ.Add( "70", "Trutnov" );
		...
		cc_reg_DK.Add( "03", "Frederiksborg" );
		cc_reg_DK.Add( "04", "Fyn" );
		cc_reg_DK.Add( "05", "Kobenhavn" );
		cc_reg_DK.Add( "06", "Staden Kobenhavn" );
		cc_reg_DK.Add( "07", "Nordjylland" );
		cc_reg_DK.Add( "08", "Ribe" );
		cc_reg_DK.Add( "09", "Ringkobing" );
		cc_reg_DK.Add( "10", "Roskilde" );
		cc_reg_DK.Add( "11", "Sonderjylland" );
		cc_reg_DK.Add( "12", "Storstrom" );
		cc_reg_DK.Add( "13", "Vejle" );
		cc_reg_DK.Add( "14", "Vestsjalland" );
		cc_reg_DK.Add( "15", "Viborg" );
		cc_reg_DK.Add( "17", "Hovedstaden" );
		cc_reg_DK.Add( "18", "Midtjyllen" );
		...
		cc_reg_ET.Add( "08", "Gambella" );
		cc_reg_ET.Add( "10", "Addis Abeba" );
		cc_reg_ET.Add( "11", "Southern" );
		cc_reg_ET.Add( "12", "Tigray" );
		cc_reg_ET.Add( "13", "Benishangul" );
		cc_reg_ET.Add( "14", "Afar" );
		...
		cc_reg_GB.Add( "07", "Cleveland" );
		cc_reg_GB.Add( "17", "Greater London" );
		cc_reg_GB.Add( "18", "Greater Manchester" );
		cc_reg_GB.Add( "20", "Hereford and Worcester" );
		cc_reg_GB.Add( "22", "Humberside" );
		cc_reg_GB.Add( "28", "Merseyside" );
		cc_reg_GB.Add( "37", "South Yorkshire" );
		cc_reg_GB.Add( "41", "Tyne and Wear" );
		cc_reg_GB.Add( "43", "West Midlands" );
		cc_reg_GB.Add( "45", "West Yorkshire" );
		cc_reg_GB.Add( "79", "Central" );
		cc_reg_GB.Add( "82", "Grampian" );
		cc_reg_GB.Add( "84", "Lothian" );
		cc_reg_GB.Add( "87", "Strathclyde" );
		cc_reg_GB.Add( "88", "Tayside" );
		cc_reg_GB.Add( "90", "Clwyd" );
		cc_reg_GB.Add( "91", "Dyfed" );
		cc_reg_GB.Add( "92", "Gwent" );
		cc_reg_GB.Add( "94", "Mid Glamorgan" );
		cc_reg_GB.Add( "96", "South Glamorgan" );
		cc_reg_GB.Add( "97", "West Glamorgan" );
		...
		cc_reg_JO.Add( "10", "Al Mafraq" );
		cc_reg_JO.Add( "11", "Amman Governorate" );
		...
		cc_reg_MA.Add( "03", "Azilal" );
		cc_reg_MA.Add( "04", "Ben Slimane" );
		cc_reg_MA.Add( "05", "Beni Mellal" );
		cc_reg_MA.Add( "06", "Boulemane" );
		cc_reg_MA.Add( "07", "Casablanca" );
		cc_reg_MA.Add( "08", "Chaouen" );
		cc_reg_MA.Add( "09", "El Jadida" );
		cc_reg_MA.Add( "10", "El Kelaa des Srarhna" );
		cc_reg_MA.Add( "11", "Er Rachidia" );
		cc_reg_MA.Add( "12", "Essaouira" );
		cc_reg_MA.Add( "13", "Fes" );
		cc_reg_MA.Add( "14", "Figuig" );
		cc_reg_MA.Add( "15", "Kenitra" );
		cc_reg_MA.Add( "16", "Khemisset" );
		cc_reg_MA.Add( "17", "Khenifra" );
		cc_reg_MA.Add( "18", "Khouribga" );
		cc_reg_MA.Add( "19", "Marrakech" );
		cc_reg_MA.Add( "20", "Meknes" );
		cc_reg_MA.Add( "21", "Nador" );
		cc_reg_MA.Add( "22", "Ouarzazate" );
		cc_reg_MA.Add( "23", "Oujda" );
		cc_reg_MA.Add( "24", "Rabat-Sale" );
		cc_reg_MA.Add( "25", "Safi" );
		cc_reg_MA.Add( "26", "Settat" );
		cc_reg_MA.Add( "27", "Tanger" );
		cc_reg_MA.Add( "29", "Tata" );
		cc_reg_MA.Add( "30", "Taza" );
		cc_reg_MA.Add( "32", "Tiznit" );
		cc_reg_MA.Add( "33", "Guelmim" );
		cc_reg_MA.Add( "34", "Ifrane" );
		cc_reg_MA.Add( "35", "Laayoune" );
		cc_reg_MA.Add( "36", "Tan-Tan" );
		cc_reg_MA.Add( "37", "Taounate" );
		cc_reg_MA.Add( "38", "Sidi Kacem" );
		cc_reg_MA.Add( "39", "Taroudannt" );
		cc_reg_MA.Add( "40", "Tetouan" );
		cc_reg_MA.Add( "41", "Larache" );
		...
		cc_reg_MD.Add( "48", "Chisinau" );
		cc_reg_MD.Add( "49", "Stinga Nistrului" );
		cc_reg_MD.Add( "50", "Edinet" );
		cc_reg_MD.Add( "51", "Gagauzia" );
		cc_reg_MD.Add( "52", "Lapusna" );
		cc_reg_MD.Add( "53", "Orhei" );
		cc_reg_MD.Add( "54", "Soroca" );
		cc_reg_MD.Add( "55", "Tighina" );
		cc_reg_MD.Add( "56", "Ungheni" );
		...
		cc_reg_MV.Add( "03", "Laviyani" );
		cc_reg_MV.Add( "04", "Waavu" );
		cc_reg_MV.Add( "05", "Laamu" );
		cc_reg_MV.Add( "07", "Haa Aliff" );
		cc_reg_MV.Add( "08", "Thaa" );
		cc_reg_MV.Add( "12", "Meemu" );
		cc_reg_MV.Add( "13", "Raa" );
		cc_reg_MV.Add( "14", "Faafu" );
		cc_reg_MV.Add( "17", "Daalu" );
		cc_reg_MV.Add( "20", "Baa" );
		cc_reg_MV.Add( "23", "Haa Daalu" );
		cc_reg_MV.Add( "24", "Shaviyani" );
		cc_reg_MV.Add( "25", "Noonu" );
		cc_reg_MV.Add( "26", "Kaafu" );
		cc_reg_MV.Add( "27", "Gaafu Aliff" );
		...
		cc_reg_NL.Add( "08", "Overijssel" );
		cc_reg_NL.Add( "09", "Utrecht" );
		cc_reg_NL.Add( "10", "Zeeland" );
		cc_reg_NL.Add( "11", "Zuid-Holland" );
		cc_reg_NL.Add( "12", "Dronten" );
		cc_reg_NL.Add( "13", "Zuidelijke IJsselmeerpolders" );
		...
		cc_reg_PL.Add( "25", "Bielsko" );
		cc_reg_PL.Add( "26", "Bydgoszcz" );
		cc_reg_PL.Add( "27", "Chelm" );
		cc_reg_PL.Add( "28", "Ciechanow" );
		cc_reg_PL.Add( "29", "Czestochowa" );
		cc_reg_PL.Add( "30", "Elblag" );
		cc_reg_PL.Add( "31", "Gdansk" );
		cc_reg_PL.Add( "32", "Gorzow" );
		cc_reg_PL.Add( "33", "Jelenia Gora" );
		cc_reg_PL.Add( "34", "Kalisz" );
		cc_reg_PL.Add( "35", "Katowice" );
		cc_reg_PL.Add( "36", "Kielce" );
		cc_reg_PL.Add( "37", "Konin" );
		cc_reg_PL.Add( "38", "Koszalin" );
		cc_reg_PL.Add( "39", "Krakow" );
		cc_reg_PL.Add( "40", "Krosno" );
		cc_reg_PL.Add( "41", "Legnica" );
		cc_reg_PL.Add( "42", "Leszno" );
		cc_reg_PL.Add( "43", "Lodz" );
		cc_reg_PL.Add( "44", "Lomza" );
		cc_reg_PL.Add( "45", "Lublin" );
		cc_reg_PL.Add( "46", "Nowy Sacz" );
		cc_reg_PL.Add( "47", "Olsztyn" );
		cc_reg_PL.Add( "48", "Opole" );
		cc_reg_PL.Add( "49", "Ostroleka" );
		cc_reg_PL.Add( "50", "Pila" );
		cc_reg_PL.Add( "51", "Piotrkow" );
		cc_reg_PL.Add( "52", "Plock" );
		cc_reg_PL.Add( "53", "Poznan" );
		cc_reg_PL.Add( "54", "Przemysl" );
		cc_reg_PL.Add( "55", "Radom" );
		cc_reg_PL.Add( "56", "Rzeszow" );
		cc_reg_PL.Add( "57", "Siedlce" );
		cc_reg_PL.Add( "58", "Sieradz" );
		cc_reg_PL.Add( "59", "Skierniewice" );
		cc_reg_PL.Add( "60", "Slupsk" );
		cc_reg_PL.Add( "61", "Suwalki" );
		cc_reg_PL.Add( "62", "Szczecin" );
		cc_reg_PL.Add( "63", "Tarnobrzeg" );
		cc_reg_PL.Add( "64", "Tarnow" );
		cc_reg_PL.Add( "65", "Torun" );
		cc_reg_PL.Add( "66", "Walbrzych" );
		cc_reg_PL.Add( "67", "Warszawa" );
		cc_reg_PL.Add( "68", "Wloclawek" );
		cc_reg_PL.Add( "69", "Wroclaw" );
		cc_reg_PL.Add( "70", "Zamosc" );
		cc_reg_PL.Add( "71", "Zielona Gora" );
		...
		cc_reg_SE.Add( "04", "Goteborgs och Bohus Lan" );
		...
		cc_reg_SI.Add( "03", "Bled" );
		cc_reg_SI.Add( "04", "Bohinj" );
		cc_reg_SI.Add( "05", "Borovnica" );
		cc_reg_SI.Add( "06", "Bovec" );
		cc_reg_SI.Add( "07", "Brda" );
		cc_reg_SI.Add( "08", "Brezice" );
		cc_reg_SI.Add( "09", "Brezovica" );
		cc_reg_SI.Add( "11", "Celje" );
		cc_reg_SI.Add( "12", "Cerklje na Gorenjskem" );
		cc_reg_SI.Add( "13", "Cerknica" );
		cc_reg_SI.Add( "14", "Cerkno" );
		cc_reg_SI.Add( "15", "Crensovci" );
		cc_reg_SI.Add( "16", "Crna na Koroskem" );
		cc_reg_SI.Add( "17", "Crnomelj" );
		cc_reg_SI.Add( "19", "Divaca" );
		cc_reg_SI.Add( "20", "Dobrepolje" );
		cc_reg_SI.Add( "22", "Dol pri Ljubljani" );
		cc_reg_SI.Add( "24", "Dornava" );
		cc_reg_SI.Add( "25", "Dravograd" );
		cc_reg_SI.Add( "26", "Duplek" );
		cc_reg_SI.Add( "27", "Gorenja Vas-Poljane" );
		cc_reg_SI.Add( "28", "Gorisnica" );
		cc_reg_SI.Add( "29", "Gornja Radgona" );
		cc_reg_SI.Add( "30", "Gornji Grad" );
		cc_reg_SI.Add( "31", "Gornji Petrovci" );
		cc_reg_SI.Add( "32", "Grosuplje" );
		cc_reg_SI.Add( "34", "Hrastnik" );
		cc_reg_SI.Add( "35", "Hrpelje-Kozina" );
		cc_reg_SI.Add( "36", "Idrija" );
		cc_reg_SI.Add( "37", "Ig" );
		cc_reg_SI.Add( "38", "Ilirska Bistrica" );
		cc_reg_SI.Add( "39", "Ivancna Gorica" );
		cc_reg_SI.Add( "40", "Izola-Isola" );
		cc_reg_SI.Add( "42", "Jursinci" );
		cc_reg_SI.Add( "44", "Kanal" );
		cc_reg_SI.Add( "45", "Kidricevo" );
		cc_reg_SI.Add( "46", "Kobarid" );
		cc_reg_SI.Add( "47", "Kobilje" );
		cc_reg_SI.Add( "49", "Komen" );
		cc_reg_SI.Add( "50", "Koper-Capodistria" );
		cc_reg_SI.Add( "51", "Kozje" );
		cc_reg_SI.Add( "52", "Kranj" );
		cc_reg_SI.Add( "53", "Kranjska Gora" );
		cc_reg_SI.Add( "54", "Krsko" );
		cc_reg_SI.Add( "55", "Kungota" );
		cc_reg_SI.Add( "57", "Lasko" );
		cc_reg_SI.Add( "61", "Ljubljana" );
		cc_reg_SI.Add( "62", "Ljubno" );
		cc_reg_SI.Add( "64", "Logatec" );
		cc_reg_SI.Add( "66", "Loski Potok" );
		cc_reg_SI.Add( "68", "Lukovica" );
		cc_reg_SI.Add( "71", "Medvode" );
		cc_reg_SI.Add( "72", "Menges" );
		cc_reg_SI.Add( "73", "Metlika" );
		cc_reg_SI.Add( "74", "Mezica" );
		cc_reg_SI.Add( "76", "Mislinja" );
		cc_reg_SI.Add( "77", "Moravce" );
		cc_reg_SI.Add( "78", "Moravske Toplice" );
		cc_reg_SI.Add( "79", "Mozirje" );
		cc_reg_SI.Add( "80", "Murska Sobota" );
		cc_reg_SI.Add( "81", "Muta" );
		cc_reg_SI.Add( "82", "Naklo" );
		cc_reg_SI.Add( "83", "Nazarje" );
		cc_reg_SI.Add( "84", "Nova Gorica" );
		cc_reg_SI.Add( "86", "Odranci" );
		cc_reg_SI.Add( "87", "Ormoz" );
		cc_reg_SI.Add( "88", "Osilnica" );
		cc_reg_SI.Add( "89", "Pesnica" );
		cc_reg_SI.Add( "91", "Pivka" );
		cc_reg_SI.Add( "92", "Podcetrtek" );
		cc_reg_SI.Add( "94", "Postojna" );
		cc_reg_SI.Add( "97", "Puconci" );
		cc_reg_SI.Add( "98", "Racam" );
		cc_reg_SI.Add( "99", "Radece" );
		cc_reg_SI.Add( "A1", "Radenci" );
		cc_reg_SI.Add( "A2", "Radlje ob Dravi" );
		cc_reg_SI.Add( "A3", "Radovljica" );
		cc_reg_SI.Add( "A6", "Rogasovci" );
		cc_reg_SI.Add( "A7", "Rogaska Slatina" );
		cc_reg_SI.Add( "A8", "Rogatec" );
		cc_reg_SI.Add( "B1", "Semic" );
		cc_reg_SI.Add( "B2", "Sencur" );
		cc_reg_SI.Add( "B3", "Sentilj" );
		cc_reg_SI.Add( "B4", "Sentjernej" );
		cc_reg_SI.Add( "B6", "Sevnica" );
		cc_reg_SI.Add( "B7", "Sezana" );
		cc_reg_SI.Add( "B8", "Skocjan" );
		cc_reg_SI.Add( "B9", "Skofja Loka" );
		cc_reg_SI.Add( "C1", "Skofljica" );
		cc_reg_SI.Add( "C2", "Slovenj Gradec" );
		cc_reg_SI.Add( "C4", "Slovenske Konjice" );
		cc_reg_SI.Add( "C5", "Smarje pri Jelsah" );
		cc_reg_SI.Add( "C6", "Smartno ob Paki" );
		cc_reg_SI.Add( "C7", "Sostanj" );
		cc_reg_SI.Add( "C8", "Starse" );
		cc_reg_SI.Add( "C9", "Store" );
		cc_reg_SI.Add( "D1", "Sveti Jurij" );
		cc_reg_SI.Add( "D2", "Tolmin" );
		cc_reg_SI.Add( "D3", "Trbovlje" );
		cc_reg_SI.Add( "D4", "Trebnje" );
		cc_reg_SI.Add( "D5", "Trzic" );
		cc_reg_SI.Add( "D6", "Turnisce" );
		cc_reg_SI.Add( "D7", "Velenje" );
		cc_reg_SI.Add( "D8", "Velike Lasce" );
		cc_reg_SI.Add( "E1", "Vipava" );
		cc_reg_SI.Add( "E2", "Vitanje" );
		cc_reg_SI.Add( "E3", "Vodice" );
		cc_reg_SI.Add( "E5", "Vrhnika" );
		cc_reg_SI.Add( "E6", "Vuzenica" );
		cc_reg_SI.Add( "E7", "Zagorje ob Savi" );
		cc_reg_SI.Add( "E9", "Zavrc" );
		cc_reg_SI.Add( "F1", "Zelezniki" );
		cc_reg_SI.Add( "F2", "Ziri" );
		cc_reg_SI.Add( "F3", "Zrece" );
		cc_reg_SI.Add( "G4", "Dobrova-Horjul-Polhov Gradec" );
		cc_reg_SI.Add( "G7", "Domzale" );
		cc_reg_SI.Add( "H4", "Jesenice" );
		cc_reg_SI.Add( "H6", "Kamnik" );
		cc_reg_SI.Add( "H7", "Kocevje" );
		cc_reg_SI.Add( "I2", "Kuzma" );
		cc_reg_SI.Add( "I3", "Lenart" );
		cc_reg_SI.Add( "I5", "Litija" );
		cc_reg_SI.Add( "I6", "Ljutomer" );
		cc_reg_SI.Add( "I7", "Loska Dolina" );
		cc_reg_SI.Add( "I9", "Luce" );
		cc_reg_SI.Add( "J1", "Majsperk" );
		cc_reg_SI.Add( "J2", "Maribor" );
		cc_reg_SI.Add( "J5", "Miren-Kostanjevica" );
		cc_reg_SI.Add( "J7", "Novo Mesto" );
		cc_reg_SI.Add( "J9", "Piran" );
		cc_reg_SI.Add( "K5", "Preddvor" );
		cc_reg_SI.Add( "K7", "Ptuj" );
		cc_reg_SI.Add( "L1", "Ribnica" );
		cc_reg_SI.Add( "L3", "Ruse" );
		cc_reg_SI.Add( "L7", "Sentjur pri Celju" );
		cc_reg_SI.Add( "L8", "Slovenska Bistrica" );
		...
		cc_reg_UG.Add( "12", "South Buganda" );
		cc_reg_UG.Add( "18", "Central" );
		cc_reg_UG.Add( "20", "Eastern" );
		cc_reg_UG.Add( "21", "Nile" );
		cc_reg_UG.Add( "22", "North Buganda" );
		...
		cc_reg_VN.Add( "22", "Lai Chau" );
		cc_reg_VN.Add( "23", "Lam Dong" );
		cc_reg_VN.Add( "24", "Long An" );
		cc_reg_VN.Add( "25", "Minh Hai" );
		cc_reg_VN.Add( "26", "Nghe Tinh" );
		cc_reg_VN.Add( "27", "Nghia Binh" );
		cc_reg_VN.Add( "28", "Phu Khanh" );
		cc_reg_VN.Add( "29", "Quang Nam-Da Nang" );
		cc_reg_VN.Add( "30", "Quang Ninh" );
		cc_reg_VN.Add( "31", "Song Be" );
		cc_reg_VN.Add( "32", "Son La" );
		cc_reg_VN.Add( "33", "Tay Ninh" );
		cc_reg_VN.Add( "34", "Thanh Hoa" );
		cc_reg_VN.Add( "35", "Thai Binh" );
		cc_reg_VN.Add( "36", "Thuan Hai" );
		cc_reg_VN.Add( "37", "Tien Giang" );
		cc_reg_VN.Add( "38", "Vinh Phu" );
		cc_reg_VN.Add( "39", "Lang Son" );
		cc_reg_VN.Add( "40", "Dong Nai" );
		cc_reg_VN.Add( "43", "An Giang" );
		cc_reg_VN.Add( "44", "Dac Lac" );
		cc_reg_VN.Add( "45", "Dong Nai" );
		cc_reg_VN.Add( "46", "Dong Thap" );
		cc_reg_VN.Add( "47", "Kien Giang" );
		cc_reg_VN.Add( "48", "Minh Hai" );
		cc_reg_VN.Add( "49", "Song Be" );
		cc_reg_VN.Add( "50", "Vinh Phu" );
		cc_reg_VN.Add( "51", "Ha Noi" );
		cc_reg_VN.Add( "52", "Ho Chi Minh" );
		cc_reg_VN.Add( "53", "Ba Ria-Vung Tau" );
		cc_reg_VN.Add( "54", "Binh Dinh" );
		cc_reg_VN.Add( "55", "Binh Thuan" );
		cc_reg_VN.Add( "56", "Can Tho" );
		cc_reg_VN.Add( "57", "Gia Lai" );
		cc_reg_VN.Add( "58", "Ha Giang" );
		cc_reg_VN.Add( "59", "Ha Tay" );
		cc_reg_VN.Add( "60", "Ha Tinh" );
		cc_reg_VN.Add( "61", "Hoa Binh" );
		cc_reg_VN.Add( "62", "Khanh Hoa" );
		cc_reg_VN.Add( "63", "Kon Tum" );
		cc_reg_VN.Add( "64", "Quang Tri" );
		cc_reg_VN.Add( "65", "Nam Ha" );
		cc_reg_VN.Add( "66", "Nghe An" );
		cc_reg_VN.Add( "67", "Ninh Binh" );
		cc_reg_VN.Add( "68", "Ninh Thuan" );
		cc_reg_VN.Add( "69", "Phu Yen" );
		cc_reg_VN.Add( "70", "Quang Binh" );
		cc_reg_VN.Add( "71", "Quang Ngai" );
		cc_reg_VN.Add( "72", "Quang Tri" );
		cc_reg_VN.Add( "73", "Soc Trang" );
		cc_reg_VN.Add( "74", "Thua Thien" );
		cc_reg_VN.Add( "75", "Tra Vinh" );
		cc_reg_VN.Add( "76", "Tuyen Quang" );
		cc_reg_VN.Add( "77", "Vinh Long" );
